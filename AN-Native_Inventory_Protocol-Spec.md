...
|CreatedDateTime|FILL ("yyyy/MM/dd hh:mm:ss")|
|StartingDateTime|FILL ("yyyy/MM/dd hh:mm:ss")|
|EndingDateTime|FILL ("yyyy/MM/dd hh:mm:ss")|
...
|TankNumber|The tank number|
|ProductCode|The fuel code. It is associated with the site|
|DateTime|FILL ("yyyy/MM/dd hh:mm:ss")|
|Volume|The volume|
